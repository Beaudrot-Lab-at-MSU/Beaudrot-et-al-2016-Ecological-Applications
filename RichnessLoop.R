# Estimate TEAM site species richness
# Format data using Uses helper functions by Jorge Ahumada (file="camera trap analysis functions.R")
# Subset appropriate site and year
# Run Dorazio et al. 2006 species richness model (file="MultiSpeciesSiteOccModel.txt")
 

load(file="ct_data2014-06-23.gzip")
...
# Parallelize code 
# Load functions from bugsParallel.r written by Mathias Tobler
n.chains <- 4
